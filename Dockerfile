...
# don't bust the heavy conda layer cache. The lockfile is the single
# source of truth and every dep resolves from conda-forge, so no sibling
# checkouts or extra apt packages are needed here.
